...
INSERT INTO `empleados` (`dni`, `nombre`, `sexo`, `categoria`, `anyosTrabajados`, `sueldo`) VALUES
	('12345', 'awd', 'H', 5, 10, 95000),
	('6789', 'qqq', 'T', 4, 1, 115000);

-- Volcando estructura para disparador nominas.update_empleado
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `update_empleado` BEFORE INSERT ON `empleados` FOR EACH ROW BEGIN
